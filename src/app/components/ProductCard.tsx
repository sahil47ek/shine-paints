...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="bg-white pt-10 rounded-xl overflow-hidden transition-all duration-300 group hover:shadow-md">
      ...
      <div className="p-6">
        ...
        <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-rose-500 transition-colors overflow-hidden whitespace-nowrap">
          <span 
        ...
        <Link
          href="/contact"
          className="block text-center bg-gradient-to-r from-rose-400 to-purple-500 text-white px-6 py-3 rounded-full text-sm font-semibold hover:opacity-90 transition-opacity"
        >
